                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="space-y-6">
                            ...
                            <p className="text-lg md:text-xl text-slate-300 leading-relaxed font-light">
                                Most manufacturing happens in a "black box"—you send a design, and weeks later, a box arrives. At Dannie, we've broken that box open. We are a
                                global <strong className="text-white font-medium">Electronic Manufacturing Services (EMS)</strong> provider powered by a proprietary MES that treats
                                every atom like a data point.
                            </p>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 relative">
                        ...
                        {[
                            ...
                            <motion.div
                                ...
                                <div className="absolute top-6 right-6 text-4xl font-black text-white/5 font-mono pointer-events-none">{item.step}</div>
            ...
            <section className="py-24 relative">
                <div className="container mx-auto px-4 max-w-6xl">
                    <div className="flex flex-col md:flex-row gap-12 mb-16">
                        <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="md:w-1/3">
                            <h2 className="text-3xl md:text-5xl font-bold text-white tracking-tight leading-tight mb-6">
                                The MES Advantage: <br />
                                <span className="text-slate-500">Why It Matters</span>
                            </h2>
                            <p className="text-lg text-slate-400 font-light pr-4">
                                In an industry where "gut feeling" often replaces "hard data," our MES application acts as the ultimate quality gatekeeper. Here is how it changes
                                the game for your project.
                            </p>
                        </motion.div>
                    ...
                    <motion.div
                        ...
                        <blockquote className="text-xl md:text-2xl font-light text-center text-white italic mb-4">"If it isn't in the MES, it didn't happen."</blockquote>
            ...
            <section className="py-32 relative text-center">
                <div className="container mx-auto px-4 max-w-4xl">
                    <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="space-y-8">
                        <h2 className="text-4xl md:text-6xl font-black text-white tracking-tight">Our Vision</h2>
                        <p className="text-xl md:text-2xl text-slate-300 font-light leading-relaxed">
                            To be the world's most transparent manufacturing partner. We aren't just your factory; we are the{' '}
                            <strong className="text-white font-medium">operating system</strong> for your hardware. By leveraging our MES application, we provide our partners with
                            something rarer than components:
                            <span className="block mt-4 text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-emerald-400">
                                Certainty.
                            </span>
                        </p>
