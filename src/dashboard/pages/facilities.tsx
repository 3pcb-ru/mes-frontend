...
export function FacilitiesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-slate-800/50 border-slate-700/50">
        ...
        <CardContent className="p-0">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 gap-4"><Building2 className="h-8 w-8 text-slate-500"/><p className="text-slate-400">No facilities found</p></div>
          ) : (
      ...
      <CrudWizard isOpen={isOpen} onClose={handleCloseWizard} title={editingItem ? "Edit Facility" : "Create Facility"} mode={editingItem ? "edit" : "create"} fields={[
